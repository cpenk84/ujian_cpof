                  ...
                  <div class="col-md-12 pl-5">
                    <div class="row">
                      <div class="icheck-success d-inline col-md-6">
                        <input type="radio" <?=($jawaban['jawaban'] == 'a') ? 'checked' : ''?> id="<?=$detail_soal_pg->id?>_pg_a" name="soal_pg_<?=$detail_soal_pg->id?>" disabled value="a" required>
                        <label style="font-weight: 500;" for="<?=$detail_soal_pg->id?>_pg_a">a. <?=$detail_soal_pg->jawaban_a?></label>
                      </div>
                      <div class="icheck-success d-inline col-md-6">
                        <input type="radio" <?=($jawaban['jawaban'] == 'b') ? 'checked' : ''?> id="<?=$detail_soal_pg->id?>_pg_b" name="soal_pg_<?=$detail_soal_pg->id?>" disabled value="b" required>
                        <label style="font-weight: 500;" for="<?=$detail_soal_pg->id?>_pg_b">b. <?=$detail_soal_pg->jawaban_b?></label>
                      </div>
                      <div class="icheck-success d-inline col-md-6">
                        <input type="radio" <?=($jawaban['jawaban'] == 'c') ? 'checked' : ''?> id="<?=$detail_soal_pg->id?>_pg_c" name="soal_pg_<?=$detail_soal_pg->id?>" disabled value="c" required>
                        <label style="font-weight: 500;" for="<?=$detail_soal_pg->id?>_pg_c">c. <?=$detail_soal_pg->jawaban_c?></label>
                      </div>
                      <div class="icheck-success d-inline col-md-6">
                        <input type="radio" <?=($jawaban['jawaban'] == 'd') ? 'checked' : ''?> id="<?=$detail_soal_pg->id?>_pg_d" name="soal_pg_<?=$detail_soal_pg->id?>" disabled value="d" required>
