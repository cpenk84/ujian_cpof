      ...
      <div class="row">
        ...
        <?php if($success > 0){?>
          ...
          <div class=" text-center">
            ...
            <button class="btn btn-success btn-lg" data-toggle="modal" data-target="#exampleModal">Buat Password Baru</button>
          </div>
        <?php }else{ ?>
          <h4 class="mb-3 text-center"><?=$msg?></h4>
  ...
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      <div class="modal-body">
        <form method="post" action="" class="test" id="reset">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" form="reset" class="btn btn-primary">Buat Password Baru</button>
      </div>
    </div>
  </div>
</div>
