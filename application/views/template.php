...
<head>
  ...
  <title>CoreUI Pro Bootstrap Admin Template By Cpenk</title>
  <!-- Icons-->
	...
	<body id="main_menu" class="app header-fixed sidebar-fixed aside-menu-fixed sidebar-lg-show">
		  ...
		  <header class="app-header navbar">
		    ...
		    <a class="navbar-brand" href="#">
		      ...
		      <img class="navbar-brand-minimized" src="<?php echo base_url();?>assets/img/avatars/logo.png" width="30" height="30" alt="CoreUI Logo">
		    </a>
